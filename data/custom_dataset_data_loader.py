...
def CreateDataLoader(opt):
    if opt.isTrain:
        ...
        return img_train_loader_static, img_train_loader_dynamic, img_test_loader_static, img_test_loader_dynamic
    else:
        img_test_dataset_static = Test_Dataset_static(opt)
        img_test_dataset_dynamic = Test_Dataset_dynamic(opt)
        ...
        return img_test_loader_static, img_test_loader_dynamic, img_test_loader_sensetime
